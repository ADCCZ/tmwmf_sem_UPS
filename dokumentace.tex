...
\draw[->, thick, dashed] (game) -- node[left, align=center] {\scriptsize timeout\\\scriptsize výpadek} (short);
\draw[->, thick, dashed] (short) to[bend left=20] node[below left, align=center] {\scriptsize RECONNECT\\\scriptsize +GAME\_STATE} (game);
